...
В проекте реализованы unit-тесты и компонентные (E2E) тесты для основных сервисов. Подробная документация по тестированию находится в файле [TESTING.md](TESTING.md).
